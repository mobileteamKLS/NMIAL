...
var BoENumber = localStorage.getItem('boENum');
var boENumber;
       ...
       console.log(obj);
        if (obj.length > 0) {
          if (obj[0].ERRORMSG == undefined) {
            ...
            boENumber=  obj[0].BoENumber;
   
            BoEID = obj[0].BoEID; 
            boEPcs = obj[0].BoE_NoP; 
            boEGrWt = obj[0].BoE_GrossWt; 
            boEChWt = obj[0].BoE_ChargeWt;
            if(obj[0].BoEID){
             BOEID =  obj[0].BoEID;
...
$("#viewList").empty();
  ...
  success: function (response, xhr, textStatus) {
    ...
    console.log(response.d);
    $("body").mLoading('hide');
    if(response.d == "No pending charges."){
        errmsg = "Alert</br>";
          errmsgcont = response.d;
          $.alert(errmsg,errmsgcont);
          return;
      }
