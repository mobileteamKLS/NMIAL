...
$(function () {
  ...
  $("#SelCTODot").css('background-color', '#00AAA2');
          ...
          if (obj[0].ERRORMSG == undefined) {
            ...
            for(var i = 0; i< allVals.length; i++){
              ...
              var newArray = obj.filter(function(p){
                if (p.HAWBGUID ==""){
                  return (p.MAWBGUID == allVals[i]);
                  
                }
                else{
                  return (p.HAWBGUID == allVals[i])
                }
    ...
    if (obj.length > 0) {
      localStorage.setItem('HouseObjectToGenerateVT',  JSON.stringify(obj));
        $.each(obj, function (i, d) {
                ...
                if (d.HAWBGUID ==""){
                  if (selectedList.includes(d.MAWBGUID)){
                        var checkId = '#cbCheck' + count;
                        $('checkId').prop('checked', true);
                        row +="<td><input type='checkbox' name='chk' value= "+ d.MAWBGUID+ " id= 'cbCheck"  + count + "' class='cbCheck'  onclick='checkClick(" + count + ");' checked/></td>"
                      }
                      else{
                        row +="<td><input type='checkbox' name='chk' value= "+ d.MAWBGUID+ " id= 'cbCheck"  + count + "' class='cbCheck'  onclick='checkClick(" + count + ");'/></td>"
                      }
                }
               
                else{
                if (selectedList.includes(d.HAWBGUID)){
                  var checkId = '#cbCheck' + count;
                  $('checkId').prop('checked', true);
                  row +="<td><input type='checkbox' name='chk' value= "+ d.HAWBGUID+ " id= 'cbCheck"  + count + "' class='cbCheck'  onclick='checkClick(" + count + ");' checked/></td>"
                }
                else{
                  row +="<td><input type='checkbox' name='chk' value= "+ d.HAWBGUID+ " id= 'cbCheck"  + count + "' class='cbCheck'  onclick='checkClick(" + count + ");'/></td>"
                }
          }
