...
function  GoToUploadBoE(){
  localStorage.setItem('ImportsMenu','Upload BoE');
  window.location.href = "IMP_BoEandOoCDetails.html";
}

function  GoToUploadOoC(){
  localStorage.setItem('ImportsMenu','Upload OoC');
  window.location.href = "IMP_BoEandOoCDetails.html";
}
...
function  GoToGenerateGatePass(){
  localStorage.setItem('ImportsMenu','Generate Gate Pass');
  window.location.href = "IMP_BoEandOoCDetails.html";
}
